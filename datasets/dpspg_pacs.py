...
class DPSPG_PACS(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        # self.split_dir = osp.join(self.dataset_dir, "dpspg_coop_splits", str(cfg.SEED))
        self.split_dir = osp.join(self.dataset_dir, "dpspg_coop_splits")
